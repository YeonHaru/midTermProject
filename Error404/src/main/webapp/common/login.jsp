...
<head>
  ...
  <!-- 스타일시트 로딩 (상대경로 또는 contextPath 활용) -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/00_style.css">
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/01_style.css">
</head>
<body>
...
<div class="login-wrapper">
  ...
  <div class="signup-button-container">
    <a href="${pageContext.request.contextPath}/common/signup.jsp" class="signup-button">회원가입</a>
  </div>
  ...
  <div class="login-box">
    ...
    <div class="login-content login-nonmember">
      ...
      <small class="login-info-text">
        조회하실 주문번호와 주문 비밀번호를 입력하세요
      </small>
