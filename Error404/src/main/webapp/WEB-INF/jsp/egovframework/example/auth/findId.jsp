...
<body>
  <div class="login-wrapper">
    ...
    <form action="${pageContext.request.contextPath}/findId.do" method="post" class="login-form">
      <input type="text" name="name" class="login-input" placeholder="이름 입력" required>
