				...
				<div class="special-book-info">
					...
					<div class="special-book-text">
						<p>
							...
							원<br /> <strong>할인가: </strong> <span class="price-sale">
								<fmt:formatNumber value="${book.dprice}" pattern="#,###" />
							</span>원<br /> <strong>배송: </strong> 무료배송<br /> <strong>수령예정일:
							</strong> 내일 도착 예정<br />
						</p>
					</div>
					...
					<div class="special-button-group">
						<form action="${pageContext.request.contextPath}/cart/add.do"
							...
							<input type="hidden" name="bno" value="${book.bno}" /> <label
								...
								class="quantity-input tcenter" name="quantity" value="1" min="1" />
						</form>
						...
						<form class="buy-now-form" method="post"
