...
<body>
  <div class="inquiry-popup">
    ...
    <form id="refundForm" method="post" action="<c:url value='/refund/submit' />">
      <div class="mb3">
        <select id="reasonSelect" name="reason" class="reason-select" required>
      ...
      <textarea
        id="inquiryText"
        name="content"
        placeholder="추가 내용을 입력하세요 (선택 사항)"
      ></textarea>

      <div class="popup-actions tcenter mt3">
        <button type="submit" id="submitBtn" class="btn pink-btn">문의 제출</button>
      </div>
    </form>
  </div>
