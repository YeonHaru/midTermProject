...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/book_all.css" />
    <!-- 	부트스트랩 css  -->
  ...
  <c:forEach var="book" items="${books}">
    <div class="book-item">
      <div class="book-list-image">
        <img src="<%= request.getContextPath() %>/images/default.jpg" alt="책 이미지" />
      </div>
      <div class="book-right">
        <div class="book-info">
          <h4 class="book-title">${book.title}</h4>
          <p class="book-desc">
			지은이 :  ${book.author}, 출판사 : ${book.publisher}
          </p>
          <div class="delivery-date">배송: 내일 도착</div>
          <br />
          <p>
            할인가 <fmt:formatNumber value="${book.dprice}" type="number" pattern="#,###"/>원 
            <del><fmt:formatNumber value="${book.fprice}" type="number" pattern="#,###"/>원</del>
          </p>
        </div>
